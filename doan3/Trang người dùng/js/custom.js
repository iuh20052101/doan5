...
function init_BookingOne() {
    ...
    $(".time-select__item").click(function () {
        ...
        //data element init
        var chooseCinema = $(this)
            .parent()
            .parent()
            .find(".time-select__place")
            .text();
...
function init_BookingTwo() {
    ...
    $(".sits__place").click(function (e) {
        ...
        var numberTicket = $(".number-ticket");
        var sumTicket = $(".sum-ticket");
        var cheapTicket = $(".cheap-ticket");
        var middleTicket = $(".middle-ticket");
        var expansiveTicket = $(".expansive-ticket");
        var sits = $(".sits");
    ...
    function ChoosePlace(e) {
        ...
        var row = $(this)
            .parent()
            .find('.sit-row option[selected="selected"]')
            .text();
        var number = $(this)
            .parent()
            .find('.sit-number option[selected="selected"]')
            .text();
        var ch_sits = row + number;
        var ticketPrice = 0;

        if (
            $(".checked-place").find(".choosen-place[data-sit='" + ch_sits + "']")
                .length
        ) {
            alert("same place");
            return 0;
        ...
        $(".sits-area--mobile .checked-place").prepend(
            '<span class="choosen-place" data-sit="' +
            ch_sits +
            '">' +
            ch_sits +
            "</span>"
        ...
        $(this).click(function (e) {
            ...
            var activeSit = $(".checked-place").find(
                ".choosen-place[data-sit='" + ch_sits + "']"
            );
...
function init_SinglePage() {
    ...
    var mySwiper = new Swiper(".swiper-container", {
        ...
        onSlideChangeStart: function change(index) {
            ...
            var prevSlide = $(".post__preview .swiper-slide")
                .eq(prev)
                .attr("data-text");
            $(".arrow-left").find(".slider__info").text(prevSlide);
            var nextSlide = $(".post__preview .swiper-slide")
                .eq(next)
                .attr("data-text");
