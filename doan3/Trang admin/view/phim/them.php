    ...
    <form action="index.php?act=themphim" method="post"  enctype="multipart/form-data">
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" placeholder="Tên Phim" name="tieu_de" required></div>
                        <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="number" placeholder="Giá Vé" name="gia_ve" min="0" required></div>
                        ...
                        <div class="col-lg-6 col-12 mb-30">
                            <select name="id_loai" id="" class="form-control" required>
