...
<link rel="stylesheet" href="assets/css/stylecolor.css">
    ...
    <div class="row justify-content-between align-items-center mb-10">
        ...
        <form action="index.php?act=ve" method="post">
            <div class="otk">
                <input type="text" class="tki" name="ten" placeholder="Tìm kiếm người dùng" 
                       value="<?= isset($_POST['ten']) ? htmlspecialchars($_POST['ten']) : '' ?>">
                <input type="text" class="tki1" name="tieude" placeholder="Tìm kiếm Phim"
                       value="<?= isset($_POST['tieude']) ? htmlspecialchars($_POST['tieude']) : '' ?>">
                <input type="text" class="tki2" name="id_ve" placeholder="Tìm kiếm id vé"
                       value="<?= isset($_POST['id_ve']) ? htmlspecialchars($_POST['id_ve']) : '' ?>">
                <input type="submit" class="tkim" name="tk" value="Tìm Kiếm">
            </div>
        </form>

        <!-- Thêm thông báo kết quả cập nhật -->
                            ...
                            <td>
                                ...
                                switch ($ve['trang_thai']) {
                                    case '1':
                                        ...
                                        break;
                                    case '2':
                                        echo '<span class="badge badge-primary">Đã sử dụng</span>';
                                        break;
                                    case '3':
