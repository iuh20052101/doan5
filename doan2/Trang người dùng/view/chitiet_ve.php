                    ...
                    echo '
                       <div class="ticket">
                        <div class="ticket-position">
                            <div class="ticket__indecator indecator--pre"><div class="indecator-text pre--text">TIAMS</div> </div>
                            <div class="ticket__inner">
                                <div class="ticket-secondary">
                                    ...
                                    <span class="ticket__item">Rạp : <span class="ticket__cinema">TIAMS</span></span>
                                ...
                                <span class="ticket__item ticket__item--primery ticket__film" style="display:flex;> <strong class="ticket__movie" >PHIM : ' . $tieu_de . '</strong></span>                                    
                            ...
                            <div class="ticket__indecator indecator--post"><div class="indecator-text post--text">TIAMS</div></div>
                        </div>
                        <div>
