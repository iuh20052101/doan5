    ...
    <form action="index.php?act=updateloai" method="POST">
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12 "><input class="form-control" type="text" placeholder="Nhập loại Phim" name="name" value="<?=$name?>"></div>
                    <div class="col-lg-6 col-12"><input class="form-control" type="text" name="id" value="<?=$id?>" ></div>
                </div>
