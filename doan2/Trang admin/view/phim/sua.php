            ...
            <div class="add-edit-product-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                        ...
                        <div class="col-lg-6 col-12 mb-30">
                        <span class="title">Giá Vé </span><br>
                        <input class="form-control" type="number_format"  name="gia_ve" value="<?= $gia_ve ?>"></div><br>
                    <div class="col-lg-6 col-12 mb-30">
                    ...
                    <div class="col-lg-6 col-12 mb-10">
                        <span class="title">Danh MụcPhim </span><br>
                ...
                <div class="product-upload-gallery row flex-wrap">
                    ...
                    <div class="row">
                        <div class="d-flex flex-wrap justify-content-end col ">
                            ...
                            <a href="index.php?act=QLphim"><button class="button button-outline button-info">Danh sách</button></a>
                        </div>
