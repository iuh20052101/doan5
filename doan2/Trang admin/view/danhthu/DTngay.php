    ...
    <div class="row justify-content-between align-items-center mb-10">
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3>Theo Dõi Doanh Thu <span>/ Doanh Thu Theo Ngày</span></h3>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-20">
        <div class="col-12">
            <form action="" method="GET" class="row">
                <input type="hidden" name="act" value="DTngay">
...
<div class="row">
    <div class="col-12 mb-30">
        <div class="box">
            <div class="box-head">
                <h3 class="title">Biểu đồ doanh thu theo ngày</h3>
            </div>
            <div class="box-body">
                <div id="myChart" style="width:100%; height:500px;"></div>
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item <?=isset($_GET['trang']) && $_GET['trang']==$i ? 'active' : ''?>">
                            <a class="page-link" href="index.php?act=DTngay&trang=<?=$i?><?=isset($_GET['rap_id']) ? '&rap_id='.$_GET['rap_id'] : ''?>">
                                <?=$i?>
                            </a>
                        </li>
                        <?php endfor; ?>
...
function drawChart() {
    const data = google.visualization.arrayToDataTable([
        ...
        <?php
        foreach ($dtt as $item) {
            echo "['".date('d/m/Y', strtotime($item['ngay']))."', "
